  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-3">
        <div className="rounded-xl bg-muted/30 p-1.5 sm:p-3 text-center flex flex-col justify-center min-w-0 overflow-hidden">
        ...
        <div className="rounded-xl bg-emerald-500/5 p-1.5 sm:p-3 text-center flex flex-col justify-center min-w-0 overflow-hidden">
        ...
        <div className="rounded-xl bg-rose-500/5 p-1.5 sm:p-3 text-center flex flex-col justify-center min-w-0 overflow-hidden">
